...
class StubTestClassCommand : ITestClassCommand
{
    ...
    public IEnumerable<ITestCommand> EnumerateTestCommands(IMethodInfo testMethod)
    {
        ...
        return EnumerateTestCommands__Result ?? MethodUtility.GetTestCommands(testMethod);
    }
    ...
    public IEnumerable<IMethodInfo> EnumerateTestMethods()
    {
        ...
        return EnumerateTestMethods__Result ?? TypeUtility.GetTestMethods(typeUnderTest);
    }
    ...
    public bool IsTestMethod(IMethodInfo testMethod)
    {
        ...
        return IsTestMethod__Result.HasValue ? IsTestMethod__Result.Value : MethodUtility.IsTest(testMethod);
    }
}