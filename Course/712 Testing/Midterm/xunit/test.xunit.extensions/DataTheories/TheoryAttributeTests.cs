...
public class TheoryAttributeTests
{
    ...
    public void TestDataFromProperty()
    {
        ...
        TheoryCommand theoryCommand = Assert.IsType<TheoryCommand>(commands[0]);
        Assert.Equal(1, theoryCommand.Parameters.Length);
        Assert.Equal<object>(theoryCommand.Parameters[0], 2);
    }
