...
76: LDC   1, 0(5)  load 0 into AC2
77: SUB   0, 1, 0  compute negative number
78: LDA   6, -1(6)  push hi
79: LDC   3, 186(5)  push hi
...
91: LD    0, -1(4)  load low into ac
92: LDA   0, 1(0)  decrease low
93: ST    0, -1(4)  save low
94: LDA   7, -12(7)  jump back to loop start
86: JLT   0, 8(7)  jump out of the fa loop
95: LDA   6, 0(4)  change sp to fp + 1
96: LD    4, 0(6)  restore fp
97: LDA   6, 1(6)  restore fp
98: LDC   0, 11(5)  load integer 11
