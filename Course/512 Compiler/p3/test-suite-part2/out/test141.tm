...
3: LDC   0, 19(5)  load array error str address
...
13: LDC   0, 3(5)  load out of memory str address
...
63: LD    0, 38(5)  load int/bool/str from static data
64: LDA   6, -1(6)  push first child's value
65: LDC   3, 39(5)  push first child's value
...
78: LD    0, 38(5)  load int/bool/str from static data
79: LDA   6, -1(6)  push first child's value
80: LDC   3, 39(5)  push first child's value
...
88: ST    0, 38(5)  store int/bool/string into previous used static data
89: LDC   0, 17(5)  load string offset 17
...
114: LDC   3, 39(5)  push int/bool/str parameter
...
106: LDC   3, 39(5)  push return address
...
125: LDC   0, 1(5)  load string offset 1
...
150: LDC   3, 39(5)  push int/bool/str parameter
...
142: LDC   3, 39(5)  push return address
...
119: LDA   7, 125(5)  jump to procedure call
2: LDA   7, 161(5)  jump to start of the program
161: LDC   0, 0(5)  load integer 0
162: ST    0, 38(5)  store int/bool/string into previous used static data
163: LDA   6, -1(6)  push fp
164: LDC   3, 39(5)  push fp
...
177: LDC   3, 39(5)  push int/bool/str parameter
...
171: LDC   3, 39(5)  push return address
...
184: ST    0, 38(5)  store int/bool/string into previous used static data
185: LDA   6, -1(6)  push fp
186: LDC   3, 39(5)  push fp
...
199: LDC   3, 39(5)  push int/bool/str parameter
...
193: LDC   3, 39(5)  push return address
