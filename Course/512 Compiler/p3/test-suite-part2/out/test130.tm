...
100: LD    4, 0(4)  load upper level fp
99: JEQ   0, 2(7)  if expr not true
102: LDA   1, 0(4)  load fp into ac2
103: LD    0, -1(1)  load int/bool/str from stack
...
113: LDC   0, 11(5)  load integer 11
114: OUT   0, 0, 0  write integer
115: OUTNL 0, 0, 0  write new line
116: HALT  0, 0, 0  program ends
