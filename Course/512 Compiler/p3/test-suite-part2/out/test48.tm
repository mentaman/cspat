...
73: LD    0, -2(1)  load int/bool/str from stack
74: OUT   0, 0, 0  write integer
75: OUTNL 0, 0, 0  write new line
76: LD    1, -1(4)  load return address
77: LDA   6, 0(4)  change sp to fp + 1
78: LD    4, 0(6)  restore fp
79: LDA   6, 1(6)  restore fp
80: LDA   7, 0(1)  jump to the return address
2: LDA   7, 81(5)  jump to start of the program
81: LDA   6, -1(6)  push fp
82: LDC   3, 79(5)  push fp
83: SUB   3, 6, 3  push fp
84: JLE   3, 13(5)  push fp
85: ST    4, 0(6)  push fp
86: LDA   4, 0(6)  set fp to sp
93: LDA   6, -1(6)  push fp
94: LDC   3, 79(5)  push fp
95: SUB   3, 6, 3  push fp
96: JLE   3, 13(5)  push fp
97: ST    4, 0(6)  push fp
98: LDA   4, 0(6)  set fp to sp
105: LDA   6, -1(6)  push zero as return value
106: LDC   3, 79(5)  push zero as return value
107: SUB   3, 6, 3  push zero as return value
108: JLE   3, 13(5)  push zero as return value
109: ST    5, 0(6)  push zero as return value
110: LDA   6, -1(6)  preserve space for local vars
111: LDA   7, 63(5)  jump to procedure call
99: LDC   0, 112(5)  load return address into ac
100: LDA   6, -1(6)  push return address
101: LDC   3, 79(5)  push return address
...
113: LDC   3, 79(5)  push int/bool/str parameter
...
117: LDA   6, 0(6)  preserve space for local vars
118: LDA   7, 72(5)  jump to procedure call
87: LDC   0, 119(5)  load return address into ac
88: LDA   6, -1(6)  push return address
89: LDC   3, 79(5)  push return address
90: SUB   3, 6, 3  push return address
91: JLE   3, 13(5)  push return address
92: ST    0, 0(6)  push return address
119: HALT  0, 0, 0  program ends
