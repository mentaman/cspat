...
64: ST    0, 129(5)  store int/bool/string into previous used static data
65: LDC   0, 2(5)  load integer 2
66: ST    0, 127(5)  store int/bool/string into previous used static data
67: LDC   0, 3(5)  load integer 3
68: ST    0, 128(5)  store int/bool/string into previous used static data
69: LDC   0, 4(5)  load integer 4
70: ST    0, 125(5)  store int/bool/string into previous used static data
71: LDC   0, 5(5)  load integer 5
72: ST    0, 126(5)  store int/bool/string into previous used static data
73: LDC   0, 1(5)  load booleantrue
74: ST    0, 123(5)  store int/bool/string into previous used static data
75: LDC   0, 1(5)  load booleantrue
76: ST    0, 124(5)  store int/bool/string into previous used static data
77: LDC   0, 1(5)  load booleantrue
78: ST    0, 130(5)  store int/bool/string into previous used static data
79: LDC   0, 1(5)  load booleantrue
80: ST    0, 131(5)  store int/bool/string into previous used static data
81: LD    0, 129(5)  load int/bool/str from static data
82: OUT   0, 0, 0  write integer
83: OUTNL 0, 0, 0  write new line
84: LD    0, 127(5)  load int/bool/str from static data
85: OUT   0, 0, 0  write integer
86: OUTNL 0, 0, 0  write new line
87: LD    0, 128(5)  load int/bool/str from static data
88: OUT   0, 0, 0  write integer
89: OUTNL 0, 0, 0  write new line
90: LD    0, 125(5)  load int/bool/str from static data
91: OUT   0, 0, 0  write integer
92: OUTNL 0, 0, 0  write new line
93: LD    0, 126(5)  load int/bool/str from static data
94: OUT   0, 0, 0  write integer
95: OUTNL 0, 0, 0  write new line
96: LD    0, 123(5)  load int/bool/str from static data
97: OUT   0, 0, 0  write integer
98: OUTNL 0, 0, 0  write new line
99: LD    0, 124(5)  load int/bool/str from static data
100: OUT   0, 0, 0  write integer
101: OUTNL 0, 0, 0  write new line
102: LD    0, 130(5)  load int/bool/str from static data
103: OUT   0, 0, 0  write integer
104: OUTNL 0, 0, 0  write new line
105: LD    0, 131(5)  load int/bool/str from static data
106: OUT   0, 0, 0  write integer
107: OUTNL 0, 0, 0  write new line
108: HALT  0, 0, 0  program ends
