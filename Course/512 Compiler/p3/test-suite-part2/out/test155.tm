...
93: ST    0, -3(1)  store int/bool/string into stack
94: LDC   0, 2(5)  load integer 2
95: LDA   1, 0(4)  load fp into ac2
96: ST    0, -4(1)  store int/bool/string into stack
97: LDC   0, 322(5)  load string offset 322
...
105: LD    0, -4(1)  load int/bool/str from stack
106: LDA   6, -1(6)  push first child's value
107: LDC   3, 354(5)  push first child's value
...
130: LDC   3, 354(5)  push zero as return value
...
135: LD    1, 0(1)  load upper level fp into ac2
136: LD    0, -2(1)  load int/bool/str from stack
137: LDA   6, -1(6)  push int/bool/str parameter
138: LDC   3, 354(5)  push int/bool/str parameter
...
142: LDA   6, -1(6)  preserve space for local vars
143: LDA   7, 23(5)  jump to procedure call
123: LDC   0, 144(5)  load return address into ac
124: LDA   6, -1(6)  push return address
125: LDC   3, 354(5)  push return address
...
146: LD    1, -1(4)  load return address
147: LDA   6, 0(4)  change sp to fp + 1
148: LD    4, 0(6)  restore fp
149: LDA   6, 1(6)  restore fp
150: LDA   7, 0(1)  jump to the return address
2: LDA   7, 151(5)  jump to start of the program
151: LDA   6, -1(6)  push fp
152: LDC   3, 354(5)  push fp
153: SUB   3, 6, 3  push fp
154: JLE   3, 13(5)  push fp
155: ST    4, 0(6)  push fp
156: LDA   4, 0(6)  set fp to sp
163: LDA   6, -3(6)  preserve space for local vars
164: LDA   7, 91(5)  jump to procedure call
157: LDC   0, 165(5)  load return address into ac
158: LDA   6, -1(6)  push return address
159: LDC   3, 354(5)  push return address
