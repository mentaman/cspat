...
3: LDC   0, 43(5)  load array error str address
...
13: LDC   0, 125(5)  load out of memory str address
...
64: ST    0, 150(5)  store int/bool/string into previous used static data
65: LD    0, 150(5)  load int/bool/str from static data
66: LDA   6, -1(6)  push first child's value
67: LDC   3, 151(5)  push first child's value
...
79: LD    0, 150(5)  load int/bool/str from static data
80: LDA   6, -1(6)  push first child's value
81: LDC   3, 151(5)  push first child's value
...
89: ST    0, 150(5)  store int/bool/string into previous used static data
90: LD    0, 150(5)  load int/bool/str from static data
