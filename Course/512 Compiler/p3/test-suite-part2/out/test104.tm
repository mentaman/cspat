...
92: ST    0, 293(5)  store int/bool/string into previous used static data
93: LDC   0, 1(5)  load booleantrue
95: LD    0, 293(5)  load int/bool/str from static data
96: OUT   0, 0, 0  write integer
97: OUTNL 0, 0, 0  write new line
98: LD    0, 293(5)  load int/bool/str from static data
99: LDA   6, -1(6)  push first child's value
100: LDC   3, 294(5)  push first child's value
101: SUB   3, 6, 3  push first child's value
102: JLE   3, 13(5)  push first child's value
103: ST    0, 0(6)  push first child's value
104: LDC   0, 3(5)  load integer 3
105: LD    1, 0(6)  pop first child's value
106: LDA   6, 1(6)  pop first child's value
107: SUB   1, 1, 0  greater than
108: LDC   0, 1(5)  load 1 as true
109: JGE   1, 1(7)  skip load false
110: LDC   0, 0(5)  load 0 as false
113: LDC   0, 83(5)  load string offset 83
114: LD    1, 0(0)  load str length into ac2
115: JEQ   1, 5(7)  output nothing when empty
116: LDA   0, 1(0)  increase offset
117: LD    2, 0(0)  load char into ac3
118: OUTC   2, 2, 2  write char
119: LDA   1, -1(1)  decrease length of remaining string in ac2
120: JNE   1, -5(7)  continue print if not yet finish
121: OUTNL 0, 0, 0  write new line
111: JEQ   0, 10(7)  if expr not true
122: LD    0, 293(5)  load int/bool/str from static data
123: LDA   6, -1(6)  push first child's value
124: LDC   3, 294(5)  push first child's value
...
131: ADD   0, 0, 1  add two children
132: ST    0, 293(5)  store int/bool/string into previous used static data
133: LDA   7, -41(7)  jump back to loop start
94: JEQ   0, 39(7)  jump out of the do loop
112: LDA   7, 21(7)  break -> jump out of the do loop
134: LDC   0, 232(5)  load string offset 232
135: LD    1, 0(0)  load str length into ac2
136: JEQ   1, 5(7)  output nothing when empty
137: LDA   0, 1(0)  increase offset
138: LD    2, 0(0)  load char into ac3
139: OUTC   2, 2, 2  write char
140: LDA   1, -1(1)  decrease length of remaining string in ac2
141: JNE   1, -5(7)  continue print if not yet finish
