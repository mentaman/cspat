...
76: LDC   0, 3(5)  load integer 3
77: LD    1, 0(6)  pop first child's value
78: LDA   6, 1(6)  pop first child's value
79: SUB   1, 1, 0  greater than
...
110: LD    2, 0(0)  load char into ac3
111: OUTC   2, 2, 2  write char
112: LDA   1, -1(1)  decrease length of remaining string in ac2
113: JNE   1, -5(7)  continue print if not yet finish
