...
65: LDC   3, 47(5)  push first child's value
...
77: LDC   0, 9(5)  load integer 9
78: LDC   1, 0(5)  load 0 into AC2
79: SUB   0, 1, 0  compute negative number
80: LDA   6, -1(6)  push first child's value
81: LDC   3, 47(5)  push first child's value
82: SUB   3, 6, 3  push first child's value
83: JLE   3, 13(5)  push first child's value
84: ST    0, 0(6)  push first child's value
85: LDC   0, 7(5)  load integer 7
86: LD    1, 0(6)  pop first child's value
87: LDA   6, 1(6)  pop first child's value
88: DIV   2, 1, 0  divide two children
89: MUL   0, 2, 0  multiply quotient and divisor
90: SUB   0, 1, 0  compute mod
91: OUT   0, 0, 0  write integer
92: OUTNL 0, 0, 0  write new line
93: LDC   0, 9(5)  load integer 9
94: LDC   1, 0(5)  load 0 into AC2
95: SUB   0, 1, 0  compute negative number
96: LDA   6, -1(6)  push first child's value
97: LDC   3, 47(5)  push first child's value
98: SUB   3, 6, 3  push first child's value
99: JLE   3, 13(5)  push first child's value
100: ST    0, 0(6)  push first child's value
101: LDC   0, 7(5)  load integer 7
102: LDC   1, 0(5)  load 0 into AC2
103: SUB   0, 1, 0  compute negative number
104: LD    1, 0(6)  pop first child's value
105: LDA   6, 1(6)  pop first child's value
106: DIV   2, 1, 0  divide two children
107: MUL   0, 2, 0  multiply quotient and divisor
108: SUB   0, 1, 0  compute mod
109: OUT   0, 0, 0  write integer
110: OUTNL 0, 0, 0  write new line
111: LDC   0, 9(5)  load integer 9
112: LDA   6, -1(6)  push first child's value
113: LDC   3, 47(5)  push first child's value
114: SUB   3, 6, 3  push first child's value
115: JLE   3, 13(5)  push first child's value
116: ST    0, 0(6)  push first child's value
117: LDC   0, 7(5)  load integer 7
118: LDC   1, 0(5)  load 0 into AC2
119: SUB   0, 1, 0  compute negative number
...
129: LDC   3, 47(5)  push first child's value
...
136: DIV   2, 1, 0  divide two children
137: MUL   0, 2, 0  multiply quotient and divisor
138: SUB   0, 1, 0  compute mod
