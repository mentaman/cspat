...
85: ST    0, 123(5)  store int/bool/string into previous used static data
86: LDA   6, -1(6)  push fp
87: LDC   3, 124(5)  push fp
88: SUB   3, 6, 3  push fp
89: JLE   3, 13(5)  push fp
90: ST    4, 0(6)  push fp
91: LDA   4, 0(6)  set fp to sp
98: LD    0, 123(5)  load int/bool/str from static data
99: LDA   6, -1(6)  push int/bool/str parameter
100: LDC   3, 124(5)  push int/bool/str parameter
...
104: LDA   6, -1(6)  preserve space for local vars
105: LDA   7, 63(5)  jump to procedure call
92: LDC   0, 106(5)  load return address into ac
93: LDA   6, -1(6)  push return address
94: LDC   3, 124(5)  push return address
95: SUB   3, 6, 3  push return address
96: JLE   3, 13(5)  push return address
97: ST    0, 0(6)  push return address
106: LD    0, 123(5)  load int/bool/str from static data
