...
92: LDA   1, 0(0)  copy AC to AC2
93: LDC   0, 1(5)  load 1 as true
94: JEQ   1, 1(7)  skip load false
95: LDC   0, 0(5)  load 0 as false
97: LDC   0, 1(5)  load integer 1
98: OUT   0, 0, 0  write integer
99: OUTNL 0, 0, 0  write new line
96: JEQ   0, 4(7)  if expr not true
101: LDC   0, 0(5)  load booleanfalse
102: LDA   1, 0(0)  copy AC to AC2
103: LDC   0, 1(5)  load 1 as true
104: JEQ   1, 1(7)  skip load false
105: LDC   0, 0(5)  load 0 as false
107: LDC   0, 2(5)  load integer 2
108: OUT   0, 0, 0  write integer
109: OUTNL 0, 0, 0  write new line
106: JEQ   0, 4(7)  if expr not true
100: LDA   7, 10(7)  Jump to the end of if
110: LDA   7, 0(7)  Jump to the end of if
111: LDC   0, 3(5)  load integer 3
112: OUT   0, 0, 0  write integer
113: OUTNL 0, 0, 0  write new line
114: LDC   0, 0(5)  load booleanfalse
115: LDA   1, 0(0)  copy AC to AC2
116: LDC   0, 1(5)  load 1 as true
117: JEQ   1, 1(7)  skip load false
118: LDC   0, 0(5)  load 0 as false
120: LDC   0, 1(5)  load integer 1
121: OUT   0, 0, 0  write integer
122: OUTNL 0, 0, 0  write new line
119: JEQ   0, 4(7)  if expr not true
124: LDC   0, 1(5)  load booleantrue
125: LDA   1, 0(0)  copy AC to AC2
126: LDC   0, 1(5)  load 1 as true
127: JEQ   1, 1(7)  skip load false
128: LDC   0, 0(5)  load 0 as false
130: LDC   0, 2(5)  load integer 2
131: OUT   0, 0, 0  write integer
132: OUTNL 0, 0, 0  write new line
129: JEQ   0, 4(7)  if expr not true
123: LDA   7, 10(7)  Jump to the end of if
133: LDA   7, 0(7)  Jump to the end of if
134: LDC   0, 3(5)  load integer 3
