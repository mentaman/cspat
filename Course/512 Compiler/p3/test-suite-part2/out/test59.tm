...
64: ST    0, 79(5)  store int/bool/string into previous used static data
65: LD    0, 79(5)  load int/bool/str from static data
66: LDA   6, -1(6)  push first child's value
67: LDC   3, 80(5)  push first child's value
...
79: LD    0, 79(5)  load int/bool/str from static data
80: LDA   6, -1(6)  push first child's value
81: LDC   3, 80(5)  push first child's value
82: SUB   3, 6, 3  push first child's value
83: JLE   3, 13(5)  push first child's value
84: ST    0, 0(6)  push first child's value
85: LDC   0, 3(5)  load integer 3
86: LD    1, 0(6)  pop first child's value
87: LDA   6, 1(6)  pop first child's value
88: SUB   1, 1, 0  greater than
89: LDC   0, 1(5)  load 1 as true
90: JEQ   1, 1(7)  skip load false
91: LDC   0, 0(5)  load 0 as false
92: JEQ   0, 1(7)  if expr not true
94: LD    0, 79(5)  load int/bool/str from static data
95: OUT   0, 0, 0  write integer
96: OUTNL 0, 0, 0  write new line
97: LD    0, 79(5)  load int/bool/str from static data
98: LDA   6, -1(6)  push first child's value
99: LDC   3, 80(5)  push first child's value
100: SUB   3, 6, 3  push first child's value
101: JLE   3, 13(5)  push first child's value
102: ST    0, 0(6)  push first child's value
103: LDC   0, 1(5)  load integer 1
104: LD    1, 0(6)  pop first child's value
105: LDA   6, 1(6)  pop first child's value
106: ADD   0, 0, 1  add two children
107: ST    0, 79(5)  store int/bool/string into previous used static data
108: LDA   7, -44(7)  jump back to loop start
78: JEQ   0, 30(7)  jump out of the do loop
93: LDA   7, 15(7)  break -> jump out of the do loop
109: LDC   0, 6(5)  load integer 6
110: OUT   0, 0, 0  write integer
111: OUTNL 0, 0, 0  write new line
112: HALT  0, 0, 0  program ends
