...
91: LDC   0, 0(5)  load booleanfalse
92: ST    0, 302(5)  store int/bool/string into previous used static data
93: LDA   6, -1(6)  push fp
94: LDC   3, 303(5)  push fp
95: SUB   3, 6, 3  push fp
96: JLE   3, 13(5)  push fp
97: ST    4, 0(6)  push fp
98: LDA   4, 0(6)  set fp to sp
99: LDC   0, 0(5)  load integer 0
100: LDA   6, -1(6)  push low
101: LDC   3, 303(5)  push low
102: SUB   3, 6, 3  push low
103: JLE   3, 13(5)  push low
104: ST    0, 0(6)  push low
105: LDC   0, 1(5)  load integer 1
106: LDA   6, -1(6)  push hi
107: LDC   3, 303(5)  push hi
108: SUB   3, 6, 3  push hi
109: JLE   3, 13(5)  push hi
110: ST    0, 0(6)  push hi
111: LD    0, -2(4)  load hi into ac 
112: LD    1, -1(4)  load low into ac2 
113: SUB   0, 0, 1  subtract hi with low
115: LDA   1, 0(4)  load fp into ac2
116: LD    0, -1(1)  load int/bool/str from stack
117: LDA   6, -1(6)  push first child's value
118: LDC   3, 303(5)  push first child's value
119: SUB   3, 6, 3  push first child's value
120: JLE   3, 13(5)  push first child's value
121: ST    0, 0(6)  push first child's value
122: LDC   0, 10(5)  load integer 10
...
128: LD    0, -1(4)  load low into ac
129: LDA   0, 1(0)  decrease low
130: ST    0, -1(4)  save low
131: LDA   7, -21(7)  jump back to loop start
114: JLT   0, 17(7)  jump out of the fa loop
132: LDA   6, 0(4)  change sp to fp + 1
133: LD    4, 0(6)  restore fp
134: LDA   6, 1(6)  restore fp
135: LD    0, 302(5)  load int/bool/str from static data
137: LDC   0, 170(5)  load string offset 170
...
136: JEQ   0, 9(7)  if expr not true
