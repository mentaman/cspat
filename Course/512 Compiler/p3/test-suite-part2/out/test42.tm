...
70: LD    0, -2(1)  load int/bool/str from stack
71: LDA   6, -1(6)  push first child's value
72: LDC   3, 49(5)  push first child's value
...
77: LD    0, -3(1)  load int/bool/str from stack
78: LD    1, 0(6)  pop first child's value
79: LDA   6, 1(6)  pop first child's value
80: ADD   0, 0, 1  add two children
81: ST    0, 48(5)  store int/bool/string into previous used static data
82: LD    1, -1(4)  load return address
83: LDA   6, 0(4)  change sp to fp + 1
84: LD    4, 0(6)  restore fp
85: LDA   6, 1(6)  restore fp
86: LDA   7, 0(1)  jump to the return address
2: LDA   7, 87(5)  jump to start of the program
87: LDC   0, 0(5)  load integer 0
88: ST    0, 48(5)  store int/bool/string into previous used static data
89: LDC   0, 0(5)  load integer 0
90: ST    0, 47(5)  store int/bool/string into previous used static data
91: LDA   6, -1(6)  push fp
92: LDC   3, 49(5)  push fp
93: SUB   3, 6, 3  push fp
94: JLE   3, 13(5)  push fp
95: ST    4, 0(6)  push fp
96: LDA   4, 0(6)  set fp to sp
103: LDA   6, -2(6)  preserve space for local vars
104: LDA   7, 63(5)  jump to procedure call
97: LDC   0, 105(5)  load return address into ac
98: LDA   6, -1(6)  push return address
99: LDC   3, 49(5)  push return address
...
108: LD    0, 47(5)  load int/bool/str from static data
109: OUT   0, 0, 0  write integer
110: OUTNL 0, 0, 0  write new line
111: HALT  0, 0, 0  program ends
