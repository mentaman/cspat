...
92: ST    0, 297(5)  store int/bool/string into previous used static data
93: LDC   0, 1(5)  load booleantrue
95: LD    0, 297(5)  load int/bool/str from static data
96: LDA   6, -1(6)  push first child's value
97: LDC   3, 298(5)  push first child's value
98: SUB   3, 6, 3  push first child's value
99: JLE   3, 13(5)  push first child's value
100: ST    0, 0(6)  push first child's value
101: LDC   0, 3(5)  load integer 3
...
109: LD    0, 297(5)  load int/bool/str from static data
110: OUT   0, 0, 0  write integer
111: OUTNL 0, 0, 0  write new line
112: LD    0, 297(5)  load int/bool/str from static data
113: LDA   6, -1(6)  push first child's value
114: LDC   3, 298(5)  push first child's value
...
122: ST    0, 297(5)  store int/bool/string into previous used static data
123: LDA   7, -29(7)  jump back to loop start
108: JEQ   0, 15(7)  jump out of the do loop
125: LDA   7, -33(7)  jump back to loop start
94: JEQ   0, 31(7)  jump out of the do loop
124: LDA   7, 1(7)  break -> jump out of the do loop
126: LDC   0, 276(5)  load string offset 276
