...
public class Ice9Parser/*@bgen(jjtree)*/implements Ice9ParserTreeConstants, Ice9ParserConstants {/*@bgen(jjtree)*/
  ...
  {
    String outputFile = "generated.tm";
...
//      n.dump("");      CodeGenerationVisitor visitor = new CodeGenerationVisitor(globalTable, stringTable, outputFile);
      ...
      System.out.println("generating TM code successfully");
    }
...
*/
 ...
 /*@bgen(jjtree) stms */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);jjtn000.jjtSetValue(TypeRecord.voidType);
    try {
      label_3:
      while (true) {
        stm();
...
*/
 ...
 /*@bgen(jjtree) PrimaryExp */
  ...
  static final public TypeRecord intTerm() throws ParseException {
 /*@bgen(jjtree) intTerm */
  ...
  jjtree.openNodeScope(jjtn000);Token t;
    ...
    debug2("this: " + jjtn000.jjtGetValue());
    jjtn000.setFirstToken(t);
    {if (true) return TypeRecord.intType;}
    } finally {
    if (jjtc000) {
      jjtree.closeNodeScope(jjtn000, true);
    }
  ...
  static final public TypeRecord boolTerm() throws ParseException {
 /*@bgen(jjtree) boolTerm */
  ...
  jjtree.openNodeScope(jjtn000);Token t;
    ...
    jjtc000 = false;
    jjtn000.setFirstToken(t);
    {if (true) return TypeRecord.boolType;}
    } finally {
    if (jjtc000) {
      jjtree.closeNodeScope(jjtn000, true);
    }
  ...
  static final public TypeRecord readTerm() throws ParseException {
 /*@bgen(jjtree) readTerm */
  ...
  static final public TypeRecord stringTerm() throws ParseException {
 ...
 /*@bgen(jjtree) noAssignExp */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xc180,0xc180,0x0,0x0,0xfca23c00,0xfca23c00,0xfca03c00,0x3000,0x0,0x8080,0x8080,0xfca23c00,0x0,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0xf0000800,0x0,0x0,0x0,0xb0000800,0x40000000,0x30000000,0x0,0xf0000800,0xf0000800,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x1f0,0x20000,0xd00021,0xd00021,0xd00021,0x0,0x8000,0x0,0x0,0xd00021,0x40000,0x0,0x8000,0x40000,0x40000,0x7e00,0x30,0x1c0,0x500021,0x400000,0x20,0x400020,0x100001,0x0,0x0,0x20000,0x500021,0x500021,0x7e00,};
   }
