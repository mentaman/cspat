...
30: LDC 2, 55(0)	* Load diagnostic char into ACC2
31: JLE 3, 52(4)	* stack failure
...
37: ADD 0, 0, 1	* Add ACC0 & ACC1 placing result in ACC0
* BEGIN: push to stack
38: LDA 3, -47(5)	* Subtract the stack limit from SP - store in ACC3
39: LDC 2, 50(0)	* Load diagnostic char into ACC2
40: JLE 3, 52(4)	* stack failure
...
44: LD 0, 0(5)	* Load stored result into ACC0
45: ST 0, 45(4)	* Store ACC0 into global offset
* END: assignment
* BEGIN: variable (rvalue) access
