...
26: LDC 0, 2(0)	* Load a constant into ACC0
...
* BEGIN: load an int constant
35: LDC 0, 4(0)	* Load a constant into ACC0
* END: load an int constant
...
48: JLT 1, 63(4)	* go to the loop exit
* BEGIN: body of for loop
* BEGIN: variable (rvalue) access
49: LD 0, -4(6)	* Load the local var into ACC0
* END: variable (rvalue) access
* BEGIN: write(s)
50: OUT 0, 0, 0	* write out the int value in ACC0
...
* BEGIN: push to stack
54: LDA 3, -46(5)	* Subtract the stack limit from SP - store in ACC3
55: LDC 2, 54(0)	* Load diagnostic char into ACC2
56: JLE 3, 66(4)	* stack failure
...
61: ST 0, -4(6)	* Store ACC0 into local offset (relative to FP)
62: LDA 7, 44(4)	* return to the top of the loop
