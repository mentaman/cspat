...
92: ST    0, 358(5)  store int/bool/string into previous used static data
93: LDC   0, 2(5)  load integer 2
94: ST    0, 356(5)  store int/bool/string into previous used static data
95: LDC   0, 3(5)  load integer 3
96: ST    0, 357(5)  store int/bool/string into previous used static data
97: LDC   0, 4(5)  load integer 4
98: ST    0, 354(5)  store int/bool/string into previous used static data
99: LDC   0, 5(5)  load integer 5
100: ST    0, 355(5)  store int/bool/string into previous used static data
101: LDC   0, 1(5)  load booleantrue
102: ST    0, 352(5)  store int/bool/string into previous used static data
103: LDC   0, 1(5)  load booleantrue
104: ST    0, 353(5)  store int/bool/string into previous used static data
105: LDC   0, 1(5)  load booleantrue
106: ST    0, 359(5)  store int/bool/string into previous used static data
107: LDC   0, 1(5)  load booleantrue
108: ST    0, 360(5)  store int/bool/string into previous used static data
109: LD    0, 358(5)  load int/bool/str from static data
110: OUT   0, 0, 0  write integer
111: OUTNL 0, 0, 0  write new line
112: LD    0, 356(5)  load int/bool/str from static data
113: OUT   0, 0, 0  write integer
114: OUTNL 0, 0, 0  write new line
115: LD    0, 357(5)  load int/bool/str from static data
116: OUT   0, 0, 0  write integer
117: OUTNL 0, 0, 0  write new line
118: LD    0, 354(5)  load int/bool/str from static data
119: OUT   0, 0, 0  write integer
120: OUTNL 0, 0, 0  write new line
121: LD    0, 355(5)  load int/bool/str from static data
122: OUT   0, 0, 0  write integer
123: OUTNL 0, 0, 0  write new line
124: LD    0, 352(5)  load int/bool/str from static data
125: OUT   0, 0, 0  write integer
126: OUTNL 0, 0, 0  write new line
127: LD    0, 353(5)  load int/bool/str from static data
128: OUT   0, 0, 0  write integer
129: OUTNL 0, 0, 0  write new line
130: LD    0, 359(5)  load int/bool/str from static data
131: OUT   0, 0, 0  write integer
132: OUTNL 0, 0, 0  write new line
133: LD    0, 360(5)  load int/bool/str from static data
134: OUT   0, 0, 0  write integer
135: OUTNL 0, 0, 0  write new line
136: HALT  0, 0, 0  program ends
