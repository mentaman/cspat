...
136: LDC   0, 133(5)  load string offset 133
137: LD    1, 0(0)  load str length into ac2
138: JEQ   1, 5(7)  output nothing when empty
139: LDA   0, 1(0)  increase offset
140: LD    2, 0(0)  load char into ac3
141: OUTC   2, 2, 2  write char
142: LDA   1, -1(1)  decrease length of remaining string in ac2
143: JNE   1, -5(7)  continue print if not yet finish
144: OUTNL 0, 0, 0  write new line
145: LD    0, -1(4)  load low into ac
146: LDA   0, 1(0)  decrease low
147: ST    0, -1(4)  save low
148: LDA   7, -18(7)  jump back to loop start
134: JLT   0, 14(7)  jump out of the fa loop
135: LDA   7, 13(7)  break -> jump out of the do loop
149: LDA   6, 0(4)  change sp to fp + 1
150: LD    4, 0(6)  restore fp
151: LDA   6, 1(6)  restore fp
152: LDC   0, 259(5)  load string offset 259
153: LD    1, 0(0)  load str length into ac2
154: JEQ   1, 5(7)  output nothing when empty
155: LDA   0, 1(0)  increase offset
156: LD    2, 0(0)  load char into ac3
157: OUTC   2, 2, 2  write char
158: LDA   1, -1(1)  decrease length of remaining string in ac2
159: JNE   1, -5(7)  continue print if not yet finish
160: OUTNL 0, 0, 0  write new line
161: LD    0, -1(4)  load low into ac
162: LDA   0, 1(0)  decrease low
163: ST    0, -1(4)  save low
164: LDA   7, -56(7)  jump back to loop start
112: JLT   0, 52(7)  jump out of the fa loop
165: LDA   6, 0(4)  change sp to fp + 1
166: LD    4, 0(6)  restore fp
167: LDA   6, 1(6)  restore fp
168: HALT  0, 0, 0  program ends
