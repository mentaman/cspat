...
101: ADD   1, 0, 1  add two children
102: LDC   0, 1(5)  load 1 as true
103: JNE   1, 1(7)  skip load false
104: LDC   0, 0(5)  load 0 as false
97: JNE   0, 7(7)  short circuit
105: OUT   0, 0, 0  write integer
106: OUTNL 0, 0, 0  write new line
107: LDC   0, 0(5)  load booleanfalse
108: LDA   6, -1(6)  push first child's value
109: LDC   3, 141(5)  push first child's value
...
117: ADD   1, 0, 1  add two children
118: LDC   0, 1(5)  load 1 as true
119: JNE   1, 1(7)  skip load false
120: LDC   0, 0(5)  load 0 as false
113: JNE   0, 7(7)  short circuit
...
125: LDC   3, 141(5)  push first child's value
...
133: ADD   1, 0, 1  add two children
134: LDC   0, 1(5)  load 1 as true
135: JNE   1, 1(7)  skip load false
136: LDC   0, 0(5)  load 0 as false
129: JNE   0, 7(7)  short circuit
...
146: LDC   0, 1(5)  load booleantrue
147: LD    1, 0(6)  pop first child's value
148: LDA   6, 1(6)  pop first child's value
149: ADD   1, 0, 1  add two children
150: LDC   0, 1(5)  load 1 as true
151: JNE   1, 1(7)  skip load false
152: LDC   0, 0(5)  load 0 as false
145: JNE   0, 7(7)  short circuit
