...
97: LDC   3, 353(5)  push first child's value
...
104: ADD   0, 0, 1  add two children
...
113: ST    0, 352(5)  store int/bool/string into previous used static data
114: LDA   6, -1(6)  push fp
115: LDC   3, 353(5)  push fp
116: SUB   3, 6, 3  push fp
117: JLE   3, 13(5)  push fp
118: ST    4, 0(6)  push fp
119: LDA   4, 0(6)  set fp to sp
126: LD    0, 352(5)  load int/bool/str from static data
127: LDA   6, -1(6)  push int/bool/str parameter
128: LDC   3, 353(5)  push int/bool/str parameter
...
133: LDA   7, 91(5)  jump to procedure call
120: LDC   0, 134(5)  load return address into ac
121: LDA   6, -1(6)  push return address
122: LDC   3, 353(5)  push return address
123: SUB   3, 6, 3  push return address
124: JLE   3, 13(5)  push return address
125: ST    0, 0(6)  push return address
134: LD    0, 352(5)  load int/bool/str from static data
