...
116: LDC   3, 302(5)  push first child's value
...
135: LDC   3, 302(5)  push first child's value
...
154: LDC   3, 302(5)  push first child's value
...
165: JEQ   0, 4(7)  if expr not true
170: LDA   1, 0(4)  load fp into ac2
171: LD    0, -1(1)  load int/bool/str from stack
172: LDA   6, -1(6)  push first child's value
173: LDC   3, 302(5)  push first child's value
174: SUB   3, 6, 3  push first child's value
175: JLE   3, 13(5)  push first child's value
176: ST    0, 0(6)  push first child's value
177: LDC   0, 3(5)  load integer 3
178: LD    1, 0(6)  pop first child's value
179: LDA   6, 1(6)  pop first child's value
180: SUB   1, 1, 0  greater than
181: LDC   0, 1(5)  load 1 as true
182: JEQ   1, 1(7)  skip load false
183: LDC   0, 0(5)  load 0 as false
185: LDC   0, 3(5)  load integer 3
186: OUT   0, 0, 0  write integer
187: OUTNL 0, 0, 0  write new line
184: JEQ   0, 4(7)  if expr not true
189: LDC   0, 4(5)  load integer 4
190: OUT   0, 0, 0  write integer
191: OUTNL 0, 0, 0  write new line
131: LDA   7, 60(7)  Jump to the end of if
150: LDA   7, 41(7)  Jump to the end of if
169: LDA   7, 22(7)  Jump to the end of if
188: LDA   7, 3(7)  Jump to the end of if
192: LD    0, -1(4)  load low into ac
193: LDA   0, 1(0)  decrease low
194: ST    0, -1(4)  save low
195: LDA   7, -87(7)  jump back to loop start
112: JLT   0, 83(7)  jump out of the fa loop
196: LDA   6, 0(4)  change sp to fp + 1
197: LD    4, 0(6)  restore fp
198: LDA   6, 1(6)  restore fp
