...
exp	-> lvalue
	...
	-> '(' exp ')'
*/
  static final public void compareOp() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case EQUAL:
      jj_consume_token(EQUAL);
      break;
    ...
    case LESSTHAN:
      ...
      break;
    case NOTGREATERTHAN:
      jj_consume_token(NOTGREATERTHAN);
      break;
    case NOTLESSTHAN:
      jj_consume_token(NOTLESSTHAN);
      break;
    default:
      jj_la1[16] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void noAssignExp() throws ParseException {
    associateExp();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case EQUAL:
    case NOTEQUAL:
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xc180,0xc180,0x0,0x0,0xfca23c00,0xfca23c00,0xfca03c00,0x0,0x8080,0x8080,0xfca23c00,0x0,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0xf0000800,0x0,0xb0000800,0x40000000,0x0,0xf0000800,0xf0000800,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x1f0,0x20000,0xd00021,0xd00021,0xd00021,0x8000,0x0,0x0,0xd00021,0x40000,0x0,0x8000,0x40000,0x40000,0x7e00,0x130,0xc0,0x500021,0x400020,0x100001,0x0,0x20000,0x500021,0x500021,0x7e00,};
   }
