...
64: ST    0, 113(5)  store int/bool/string into previous used static data
65: LDC   0, 1(5)  load integer 1
66: ST    0, 111(5)  store int/bool/string into previous used static data
67: LDC   0, 1(5)  load booleantrue
68: ST    0, 110(5)  store int/bool/string into previous used static data
69: LD    0, 113(5)  load int/bool/str from static data
70: OUT   0, 0, 0  write integer
71: OUTNL 0, 0, 0  write new line
72: LD    0, 111(5)  load int/bool/str from static data
73: OUT   0, 0, 0  write integer
74: OUTNL 0, 0, 0  write new line
75: LD    0, 110(5)  load int/bool/str from static data
76: OUT   0, 0, 0  write integer
77: OUTNL 0, 0, 0  write new line
78: HALT  0, 0, 0  program ends
