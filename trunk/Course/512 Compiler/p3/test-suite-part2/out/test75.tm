...
68: LDC   3, 65(5)  push array index
...
74: LDC   3, 65(5)  push array index
...
98: LD    1, 59(5)  load global offset into ac2
99: ADD   0, 0, 1  compute final offset
100: LD    0, 0(0)  load data from array
101: ST    0, 64(5)  store int/bool/string into previous used static data
