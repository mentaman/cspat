...
93: LDC   0, 100(5)  load string offset 100
...
92: JEQ   0, 9(7)  if expr not true
102: LDC   0, 246(5)  load string offset 246
103: LD    1, 0(0)  load str length into ac2
104: JEQ   1, 5(7)  output nothing when empty
105: LDA   0, 1(0)  increase offset
106: LD    2, 0(0)  load char into ac3
107: OUTC   2, 2, 2  write char
108: LDA   1, -1(1)  decrease length of remaining string in ac2
109: JNE   1, -5(7)  continue print if not yet finish
