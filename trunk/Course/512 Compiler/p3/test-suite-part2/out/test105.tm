...
64: ST    0, 181(5)  store int/bool/string into previous used static data
65: LDC   0, 1(5)  load booleantrue
67: LD    0, 181(5)  load int/bool/str from static data
68: LDA   6, -1(6)  push first child's value
69: LDC   3, 182(5)  push first child's value
...
81: LD    0, 181(5)  load int/bool/str from static data
82: OUT   0, 0, 0  write integer
83: OUTNL 0, 0, 0  write new line
84: LD    0, 181(5)  load int/bool/str from static data
85: LDA   6, -1(6)  push first child's value
86: LDC   3, 182(5)  push first child's value
...
94: ST    0, 181(5)  store int/bool/string into previous used static data
...
98: LDC   0, 131(5)  load string offset 131
