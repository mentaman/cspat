...
124: LD    1, -6(1)  load local offset into ac2
125: ADD   0, 0, 1  compute final offset
126: LDA   6, -1(6)  push final offset
127: LDC   3, 220(5)  push final offset
128: SUB   3, 6, 3  push final offset
129: JLE   3, 13(5)  push final offset
130: ST    0, 0(6)  push final offset
131: LDC   0, 0(5)  load integer 0
132: LD    1, 0(6)  pop final offset
133: LDA   6, 1(6)  pop final offset
134: ST    0, 0(1)  store value into array static data
135: LD    1, -1(4)  load return address
136: LDA   6, 0(4)  change sp to fp + 1
137: LD    4, 0(6)  restore fp
138: LDA   6, 1(6)  restore fp
139: LDA   7, 0(1)  jump to the return address
2: LDA   7, 140(5)  jump to start of the program
140: LDA   6, -1(6)  push fp
141: LDC   3, 220(5)  push fp
142: SUB   3, 6, 3  push fp
143: JLE   3, 13(5)  push fp
144: ST    4, 0(6)  push fp
145: LDA   4, 0(6)  set fp to sp
152: LDC   0, 4(5)  load array localVariableSize: 4
153: SUB   0, 6, 0  compute absolute address of the array
154: ST    0, -5(6)  store absolute array address
155: LDA   6, -5(6)  preserve space for local vars
156: LDA   7, 91(5)  jump to procedure call
146: LDC   0, 157(5)  load return address into ac
147: LDA   6, -1(6)  push return address
148: LDC   3, 220(5)  push return address
149: SUB   3, 6, 3  push return address
150: JLE   3, 13(5)  push return address
151: ST    0, 0(6)  push return address
157: HALT  0, 0, 0  program ends
