...
68: LDC   3, 108(5)  push array index
...
83: LD    1, 104(5)  load global offset into ac2
84: ADD   0, 0, 1  compute final offset
85: LD    0, 0(0)  load data from array
86: ST    0, 107(5)  store int/bool/string into previous used static data
87: HALT  0, 0, 0  program ends
