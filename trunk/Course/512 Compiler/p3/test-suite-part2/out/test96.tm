...
13: LDC   0, 55(5)  load out of memory str address
...
64: ST    0, 84(5)  store int/bool/string into previous used static data
65: LDC   0, 1(5)  load booleantrue
66: ST    0, 82(5)  store int/bool/string into previous used static data
67: LDC   0, 1(5)  load booleantrue
68: ST    0, 84(5)  store int/bool/string into previous used static data
69: LDC   0, 0(5)  load booleanfalse
70: LDA   1, 0(0)  copy AC to AC2
71: LDC   0, 1(5)  load 1 as true
72: JEQ   1, 1(7)  skip load false
73: LDC   0, 0(5)  load 0 as false
74: ST    0, 82(5)  store int/bool/string into previous used static data
75: LDC   0, 1(5)  load string offset 1
76: ST    0, 83(5)  store int/bool/string into previous used static data
77: LD    0, 84(5)  load int/bool/str from static data
78: OUT   0, 0, 0  write integer
79: OUTNL 0, 0, 0  write new line
80: LD    0, 82(5)  load int/bool/str from static data
81: OUT   0, 0, 0  write integer
82: OUTNL 0, 0, 0  write new line
83: LD    0, 83(5)  load int/bool/str from static data
84: LD    1, 0(0)  load str length into ac2
85: JEQ   1, 5(7)  output nothing when empty
