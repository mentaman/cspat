...
92: ST    0, 159(5)  store int/bool/string into previous used static data
93: LDC   0, 1(5)  load integer 1
94: ST    0, 157(5)  store int/bool/string into previous used static data
95: LDC   0, 1(5)  load booleantrue
96: ST    0, 158(5)  store int/bool/string into previous used static data
97: LDC   0, 0(5)  load booleanfalse
98: ST    0, 155(5)  store int/bool/string into previous used static data
99: LDC   0, 5(5)  load string offset 5
100: ST    0, 156(5)  store int/bool/string into previous used static data
101: LDC   0, 104(5)  load string offset 104
102: ST    0, 154(5)  store int/bool/string into previous used static data
103: LD    0, 159(5)  load int/bool/str from static data
104: OUT   0, 0, 0  write integer
105: OUTNL 0, 0, 0  write new line
106: LD    0, 157(5)  load int/bool/str from static data
107: OUT   0, 0, 0  write integer
108: OUTNL 0, 0, 0  write new line
109: LD    0, 158(5)  load int/bool/str from static data
110: OUT   0, 0, 0  write integer
111: OUTNL 0, 0, 0  write new line
112: LD    0, 155(5)  load int/bool/str from static data
113: OUT   0, 0, 0  write integer
114: OUTNL 0, 0, 0  write new line
115: LD    0, 156(5)  load int/bool/str from static data
...
124: LD    0, 154(5)  load int/bool/str from static data
