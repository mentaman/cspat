...
13: LDC   0, 80(5)  load out of memory str address
...
64: LDC   3, 113(5)  push fp
65: SUB   3, 6, 3  push fp
66: JLE   3, 13(5)  push fp
67: ST    4, 0(6)  push fp
68: LDA   4, 0(6)  set fp to sp
75: LDA   6, -1(6)  push zero as return value
76: LDC   3, 113(5)  push zero as return value
77: SUB   3, 6, 3  push zero as return value
78: JLE   3, 13(5)  push zero as return value
79: ST    5, 0(6)  push zero as return value
80: LDC   0, 54(5)  load string offset 54
81: LDA   6, -1(6)  push int/bool/str parameter
82: LDC   3, 113(5)  push int/bool/str parameter
83: SUB   3, 6, 3  push int/bool/str parameter
84: JLE   3, 13(5)  push int/bool/str parameter
85: ST    0, 0(6)  push int/bool/str parameter
86: LDA   6, -1(6)  preserve space for local vars
87: LDA   7, 23(5)  jump to procedure call
69: LDC   0, 88(5)  load return address into ac
70: LDA   6, -1(6)  push return address
71: LDC   3, 113(5)  push return address
72: SUB   3, 6, 3  push return address
73: JLE   3, 13(5)  push return address
74: ST    0, 0(6)  push return address
88: ST    0, 112(5)  store int/bool/string into previous used static data
89: LD    0, 112(5)  load int/bool/str from static data
90: OUT   0, 0, 0  write integer
