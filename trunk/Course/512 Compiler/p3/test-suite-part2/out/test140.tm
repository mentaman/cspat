...
3: LDC   0, 56(5)  load array error str address
...
13: LDC   0, 150(5)  load out of memory str address
...
91: LDC   0, 51(5)  load string offset 51
92: ST    0, 349(5)  store int/bool/string into previous used static data
93: LDA   6, -1(6)  push fp
94: LDC   3, 350(5)  push fp
95: SUB   3, 6, 3  push fp
96: JLE   3, 13(5)  push fp
97: ST    4, 0(6)  push fp
98: LDA   4, 0(6)  set fp to sp
105: LDA   6, -1(6)  push zero as return value
106: LDC   3, 350(5)  push zero as return value
107: SUB   3, 6, 3  push zero as return value
108: JLE   3, 13(5)  push zero as return value
109: ST    5, 0(6)  push zero as return value
110: LD    0, 349(5)  load int/bool/str from static data
111: LDA   6, -1(6)  push int/bool/str parameter
112: LDC   3, 350(5)  push int/bool/str parameter
...
116: LDA   6, -1(6)  preserve space for local vars
117: LDA   7, 23(5)  jump to procedure call
99: LDC   0, 118(5)  load return address into ac
100: LDA   6, -1(6)  push return address
101: LDC   3, 350(5)  push return address
102: SUB   3, 6, 3  push return address
103: JLE   3, 13(5)  push return address
104: ST    0, 0(6)  push return address
118: ST    0, 348(5)  store int/bool/string into previous used static data
119: LD    0, 349(5)  load int/bool/str from static data
120: LD    1, 0(0)  load str length into ac2
121: JEQ   1, 5(7)  output nothing when empty
122: LDA   0, 1(0)  increase offset
123: LD    2, 0(0)  load char into ac3
124: OUTC   2, 2, 2  write char
125: LDA   1, -1(1)  decrease length of remaining string in ac2
126: JNE   1, -5(7)  continue print if not yet finish
127: OUTNL 0, 0, 0  write new line
128: LD    0, 348(5)  load int/bool/str from static data
