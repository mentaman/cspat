...
76: LD    0, -5(1)  load int/bool/str from stack
77: LD    1, 0(0)  load str length into ac2
78: JEQ   1, 5(7)  output nothing when empty
79: LDA   0, 1(0)  increase offset
80: LD    2, 0(0)  load char into ac3
81: OUTC   2, 2, 2  write char
82: LDA   1, -1(1)  decrease length of remaining string in ac2
83: JNE   1, -5(7)  continue print if not yet finish
84: OUTNL 0, 0, 0  write new line
85: LD    1, -1(4)  load return address
86: LDA   6, 0(4)  change sp to fp + 1
87: LD    4, 0(6)  restore fp
88: LDA   6, 1(6)  restore fp
89: LDA   7, 0(1)  jump to the return address
2: LDA   7, 90(5)  jump to start of the program
90: LDA   6, -1(6)  push fp
91: LDC   3, 123(5)  push fp
92: SUB   3, 6, 3  push fp
93: JLE   3, 13(5)  push fp
94: ST    4, 0(6)  push fp
95: LDA   4, 0(6)  set fp to sp
102: LDC   0, 0(5)  load integer 0
103: LDA   6, -1(6)  push int/bool/str parameter
104: LDC   3, 123(5)  push int/bool/str parameter
105: SUB   3, 6, 3  push int/bool/str parameter
106: JLE   3, 13(5)  push int/bool/str parameter
107: ST    0, 0(6)  push int/bool/str parameter
108: LDC   0, 1(5)  load integer 1
109: LDA   6, -1(6)  push int/bool/str parameter
110: LDC   3, 123(5)  push int/bool/str parameter
...
114: LDC   0, 1(5)  load booleantrue
115: LDA   6, -1(6)  push int/bool/str parameter
116: LDC   3, 123(5)  push int/bool/str parameter
...
120: LDC   0, 1(5)  load string offset 1
121: LDA   6, -1(6)  push int/bool/str parameter
122: LDC   3, 123(5)  push int/bool/str parameter
123: SUB   3, 6, 3  push int/bool/str parameter
124: JLE   3, 13(5)  push int/bool/str parameter
125: ST    0, 0(6)  push int/bool/str parameter
126: LDA   6, 0(6)  preserve space for local vars
127: LDA   7, 63(5)  jump to procedure call
96: LDC   0, 128(5)  load return address into ac
97: LDA   6, -1(6)  push return address
98: LDC   3, 123(5)  push return address
99: SUB   3, 6, 3  push return address
100: JLE   3, 13(5)  push return address
101: ST    0, 0(6)  push return address
