...
67: LD    0, -3(1)  load int/bool/str from stack
69: LDC   0, 1(5)  load integer 1
70: LDA   1, 0(4)  load fp into ac2
71: ST    0, -2(1)  store int/bool/string into stack
68: JEQ   0, 5(7)  if expr not true
74: LDC   0, 2(5)  load integer 2
75: LDA   1, 0(4)  load fp into ac2
76: ST    0, -2(1)  store int/bool/string into stack
73: LDA   7, 4(7)  Jump to the end of if
78: LDC   0, 3(5)  load integer 3
79: LDA   1, 0(4)  load fp into ac2
80: ST    0, -2(1)  store int/bool/string into stack
72: LDA   7, 8(7)  return procedure call
77: LDA   7, 3(7)  return procedure call
81: LD    0, -2(4)  load int/bool/string offset as return value
...
137: LDA   6, -1(6)  preserve space for local vars
