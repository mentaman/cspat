...
.DATA 0	* storage location (45) for var c
.DATA 0	* storage location (46) for var d
...
21: ST 0, 48(4)	* Store ACC0 into global offset
* END: assignment
...
30: ST 0, 46(4)	* Store ACC0 into global offset
* END: assignment
* BEGIN: variable (rvalue) access
31: LD 0, 47(4)	* Load the global var into ACC0
...
* END: write(s)
* BEGIN: variable (rvalue) access
34: LD 0, 48(4)	* Load the global var into ACC0
* END: variable (rvalue) access
* BEGIN: write(s)
...
* END: write(s)
* BEGIN: variable (rvalue) access
37: LD 0, 46(4)	* Load the global var into ACC0
* END: variable (rvalue) access
* BEGIN: write(s)
