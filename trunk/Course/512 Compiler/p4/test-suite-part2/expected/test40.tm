...
* SP already points to end of the AR
25: LDA 7, 35(4)	* Jump to the start of the proc
...
30: LDC 0, 2(0)	* Load a constant into ACC0
...
* END: write(s)
39: LD 0, 0(6)	* Load the return address from the 1st slot in the AR to ACC0
40: LDA 7, 0(0)	* Return to calling location (stored in ACC0)
* END: procedure code
