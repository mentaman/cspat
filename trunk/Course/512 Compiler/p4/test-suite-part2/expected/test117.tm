...
* END: write(s)
83: LDA 7, 26(7)	* Jump over the rest of the if
* BEGIN: variable (rvalue) access
...
* END: write(s)
102: LDA 7, 7(7)	* Jump over the rest of the if
* BEGIN: load an int constant
...
* END: write(s)
* BEGIN: break
106: LDA 7, 121(4)	* skip to the end of the loop
* END: break
* BEGIN: load an int constant
