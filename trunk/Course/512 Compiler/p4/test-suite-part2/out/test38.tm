...
100: LDC   3, 154(5)  push fp
101: SUB   3, 6, 3  push fp
102: JLE   3, 13(5)  push fp
103: ST    4, 0(6)  push fp
104: LDA   4, 0(6)  set fp to sp
111: LDA   6, 0(6)  preserve space for local vars
112: LDA   7, 91(5)  jump to procedure call
105: LDC   0, 113(5)  load return address into ac
106: LDA   6, -1(6)  push return address
107: LDC   3, 154(5)  push return address
108: SUB   3, 6, 3  push return address
109: JLE   3, 13(5)  push return address
110: ST    0, 0(6)  push return address
113: LDA   6, -1(6)  push fp
114: LDC   3, 154(5)  push fp
115: SUB   3, 6, 3  push fp
116: JLE   3, 13(5)  push fp
117: ST    4, 0(6)  push fp
118: LDA   4, 0(6)  set fp to sp
125: LDA   6, 0(6)  preserve space for local vars
126: LDA   7, 91(5)  jump to procedure call
119: LDC   0, 127(5)  load return address into ac
120: LDA   6, -1(6)  push return address
121: LDC   3, 154(5)  push return address
122: SUB   3, 6, 3  push return address
123: JLE   3, 13(5)  push return address
124: ST    0, 0(6)  push return address
