...
96: LDC   3, 318(5)  push array index
...
114: LDC   3, 318(5)  push final offset
...
124: LDC   3, 318(5)  push array index
...
167: LD    1, 314(5)  load offset into ac2
168: ADD   0, 0, 1  compute final offset
169: LDA   6, -1(6)  push final offset
170: LDC   3, 318(5)  push final offset
171: SUB   3, 6, 3  push final offset
172: JLE   3, 16(5)  push final offset
173: ST    0, 0(6)  push final offset
174: LDC   0, 2(5)  load integer 2
175: LD    1, 0(6)  pop final offset
176: LDA   6, 1(6)  pop final offset
177: ST    0, 0(1)  store value into array static data
178: LDC   0, 1(5)  load integer 1
179: LDA   6, -1(6)  push array index
180: LDC   3, 318(5)  push array index
181: SUB   3, 6, 3  push array index
182: JLE   3, 16(5)  push array index
183: ST    0, 0(6)  push array index
184: LDC   0, 1(5)  push array dimension
185: LDC   0, 0(5)  load 0 to ac
186: LD    1, 0(6)  pop index
187: LDA   6, 1(6)  pop index
188: JLT   1, 6(5)  jump if index less than 0
189: LDC   3, 3(5)  load array size
190: SUB   3, 3, 1  sub max size with index
191: JLE   3, 6(5)  jump if index greater than size - 1
192: LDC   2, 1(5)  load size of subarray
193: MUL   1, 1, 2  compute 0 dim
194: ADD   0, 0, 1  add result
195: LD    1, 314(5)  load global offset into ac2
196: ADD   0, 0, 1  compute final offset
197: LD    0, 0(0)  load data from array
