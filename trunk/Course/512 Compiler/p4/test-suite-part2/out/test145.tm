...
119: LDC   3, 353(5)  push int/bool/str parameter
...
124: LDA   7, 91(5)  jump to procedure call
111: LDC   0, 125(5)  load return address into ac
...
125: LD    0, 352(5)  load int/bool/str from static data
