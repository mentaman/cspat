...
.DATA    9
.SDATA   "i am a[0]"
0: LDC   0, 221(5)  store array start address: 221
1: LDC   1, 220(5)  store array offset into ac2: 220
...
16: LDC   0, 104(5)  load out of memory str address
...
94: LDC   0, 3(5)  load integer 3
95: LDA   6, -1(6)  push array index
96: LDC   3, 226(5)  push array index
...
102: LDC   3, 226(5)  push array index
...
126: LD    1, 220(5)  load global offset into ac2
127: ADD   0, 0, 1  compute final offset
128: LD    0, 0(0)  load data from array
129: ST    0, 225(5)  store int/bool/string into previous used static data
