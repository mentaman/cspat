...
<configuration!>
    ...
    public class EnumerateTests
    {
        ...
        public void AcceptanceTest()
        {
            ...
            Assert.Equal(1, traitsNodes.Count);
            XmlNode traitNode = traitsNodes[0];
    ...
    public class RunTests
    {
        ...
        public void TestMethodWithNonTestMethod()
        {
            ...
            using (MockAssembly assembly = new MockAssembly())
            {
                ...
                Assert.Equal(1, lastNode.ChildNodes.Count); // Only the test method
        ...
        public void NonPublicTestMethod()
        {
            ...
            using (MockAssembly assembly = new MockAssembly())
            {
                ...
                Assert.Equal(1, returnValue.ChildNodes.Count);
